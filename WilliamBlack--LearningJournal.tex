...
1. \includegraphics[scale=0.8]{imgdcrcolorplot.PNG}
...
1. \includegraphics[scale=0.4]{imgdcrviolin.PNG}

2. \includegraphics[scale=0.4]{imgdcrboxlivcount.PNG}

3. \includegraphics[scale=0.5]{imgdcrboxcolor.PNG}
...
\begin{itemize}
    ...
    \item How to use chunking to design a research report
\end{itemize}

\section{13.03.20 - Proof of Concept: PICO Presentation}

Wrote and recorded the two-minute madness, but realised I forgot to mention it's a LaTeX style package, so will add that to the top of the slides and keep the audio I have. Also feel the slides are a bit too busy to read while I speak so I'll defocus the dummy text in the video. In a real life presentation I would have been able to point out what I'm talking about and engage people with eye contact, etc.

I submitted the project to CTAN.org but haven't had any response back yet.
